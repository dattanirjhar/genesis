...
PARSER_ORDER = [
    # XML / JSON with distinctive key signatures (most specific first)
    "nmap", "nuclei", "nikto", "whatweb", "amass", "katana", "naabu", "httpx",
    # text: distinctive markers first
    "gobuster", "sqlmap", "subfinder",
]
